...
VALUES ('Panel Room', 'Lakeshore B'), ('Kids Corner', 'Regency Ballroom'), ('Tabletop', 'Exhibition Hall'), ('Arcade', 'Exhibition Hall'), ('Console State', 'Greenway Ballroom'), ('LAN Area', 'Exhibition Hall'), ('Main Stage', 'Main Stage'), ('Tournament Room', 'Lakeshore A');

--TAGS--
INSERT INTO "Tags" ("TagName")
VALUES ('Fan Run'), ('Panel'), ('Guests'), ('Family Friendly'), ('PS4');

--SPONSORS--
INSERT INTO "Sponsor" ("SponsorName", "AmountPaid", "Website")
VALUES ('Level Up Games', '2,000', 'https://www.levelupgamesmn.com/'), ('Highlander Games', '5,000', 'http://highlandergamesmn.com/'), ('Paradise Arcade Shop', '3,000', 'https://paradisearcadeshop.com'),('Anime Twin Cities', '4,000', 'https://www.animetwincities.org/'), ('Discord', '20,000', 'https://discordapp.com/'), ('Twitch', '30,000', 'https://www.twitch.tv/2dcon');

--SPONSORS W/ NOTES
INSERT INTO "Sponsor" ("SponsorName", "AmountPaid", "Website", "Notes")
VALUES ('Up Down Minneapolis', '6,000', 'https://www.updownarcadebar.com/minneapolis/', 'donating an arcade game this year!');

--EVENTS--
INSERT INTO "Event" ("ConventionID", "EventName", "EventStartTime", "EventEndTime", "LocationID", "IsCancelled", "EventDescription", "DateCreated")
VALUES ('1', 'Gamer Yoga', '08/23/2018 1:00 PM', '08/23/2018 2:00 PM', '2', 'FALSE', 'Want to level up your body at the same time you level up your game? Join us at the kids corner (all ages welcome) and bring your favorite gaming controller or handheld gaming device to experience gaming in the here and now.', '08/22/2018'), ('2', 'Century: Spice Road Trip Tournament', '08/25/2019 2:00 PM', '08/25/2019 6:00 PM', '3', 'FALSE', 'Century: Spice Road is the first in a series of games that explores the history of each century with spice-trading as the theme for the first installment.', '08/03/2019'), ('3', 'Tekken 7', '08/26/2020 1:00 PM', '08/26/2020 6:00 PM', '8', 'FALSE', 'Tekken 7!', '07/27/2020');
...
--CANCELLED EVENTS--
INSERT INTO "Event" ("ConventionID", "EventName", "EventStartTime", "EventEndTime", "LocationID", "IsCancelled", "EventDescription", "DateCreated")
VALUES ('3', 'Marvel Vs. Capcom 2', '08/24/2020 2:00 PM', '08/24/2020 5:00 PM', '4', 'TRUE', 'wow!', '08/22/2020');

--MODIFIED EVENTS--
INSERT INTO "Event" ("ConventionID", "EventName", "EventStartTime", "EventEndTime", "LocationID", "IsCancelled", "EventDescription", "DateCreated", "DateLastModified", "EventModifiedNotes")
VALUES ('3', 'Dragon Ball FighterZ', '08/24/2020 2:00 PM', '08/24/2020 5:00 PM', '4', 'FALSE', 'haha!', '08/22/2020', '08/23/2020', 'please ensure all our guest keep it in under control');

--EVENT TAGS--
INSERT INTO "EventTags" ("Event_ID", "Tag_ID")
VALUES ('1' , '4'), ('1', '5'), ('3', '1'), ('6', '1');